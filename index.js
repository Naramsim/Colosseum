...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "dive-ball93466593fa5c9e0ea6851e71f8a3b772.png";

/***/ }),
/* 15 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "quick-balle50af04acd504fb61c5430058b7f2c62.png";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pokemons = __webpack_require__(37);
	...
	var _getColors = __webpack_require__(39);
	
	var _getColors2 = _interopRequireDefault(_getColors);
	
	var _getHappiness = __webpack_require__(41);
	
	var _getHappiness2 = _interopRequireDefault(_getHappiness);
	
	var _recentPokemons = __webpack_require__(42);
	
	var _currentPokemon = __webpack_require__(43);
...
/***/ (function(module, exports) {
	...
	module.exports = [["Prof. Oak","Pokémon around the world wait for you, Ash."],["Prof. Oak","So, tell me about yourself. Are you a boy or a girl?"],["Prof. Oak","I came when I heard you defeated the Elite Four"],["Dark Cave lass","Don't try anything funny in the dark!"],["Sailor","I like feisty kids like you"],["Youngster","I like shorts! They're comfy and easy to wear!"],["Youngster Joey","My Rattata is the top percentage of all Rattata!"],["Barry","It's a $10 million fine if you're late!"],["Gary Oak","Smell you Later!"],["Juggler","Dropped my balls!"],["Mom","Oh...you look tired. Why don't you take a rest?"],["Blaine","You better have Burn Heal"],["Nurse","We hope to see you again"],["Team Rocket guy","I Dropped The Lift Key"],["Celadon old man","Hehehe! This gym is full of women!"],["Ash","It's a secret switch! Press﻿ it? Who wouldn't?"],["Team Rocket Guy","Don't touch the poster at the Game Corner! There's no secret switch behind it!"],["Route 3 lass","You looked at me, didn't you?"],["Slateport swimmer","Cheeks are most prone to burning."],["Red","..."],["Prof. Oak","It's not winning if your opponent is at a disadvantage"],["Young fisherman","I'll beat you with the magikarp my dad gave me"],["Team Rocket grunt","Develop amnesia conveniently and forget everything you heard!"],["Barry","We need Poké balls! P-O-K-E balls!"],["Youngster Kevin","These are not shorts! These are half-pants!"],["Prof. Oak","There's a time and place for everything, but not now."],["Skyla","Heads up! Make sure you are ready for it!"],["Nebulablue","Hell no, I can't be seen with that ****."],["Route 23 lass","It seems it ran away crying"],["Harley","Gotta go powder my nose!"],["A girl","Oh yes, im a girl"],["Old man","You remind me of my lost love. Yes, spitting image"],["Swimmer","You have to come from SOMEWHERE, right?"],["Young couple","Our love didnt work?"],["Old Route 111 lady","There's no need to be shy about it"],["Seven island guy","Do the Chansey Dance!"],["Six island girl","Hera, hera, HERACROSS!"],["Route 11 gamer","Fwahaha! I've never lost!"],["Rock Tunnel hiker","Hit me with your best shot!"],["Youngster Regis","Youngster? How rude! Call me Shorts Boy!"],["Battle Frontier woman","Here it is a sweet kiss from my Jynx"],["Mt. Chimney hiker","There are many hot trainers for company!"]]
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rbg = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getMemebers = __webpack_require__(46);
	    ...
	    $scope.$on('init', function () {
	        if ($rootScope.pokemonSpecie) {
	            ...
	            if (evolutionChainId && evolutionChainId.length > 0) {
	                $http.get(_config.config.baseUrl + '/evolution-chain/' + evolutionChainId[1]).success(function (res) {
	                    $scope.family = res;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getFavouritePokemons = __webpack_require__(50);
		...
		$scope.$on('init', function () {
			$scope.getAbility = function (url) {
				...
				if (id && id.length > 0) {
					...
					if (!localAbility) {
						$http.get(_config.config.baseUrl + '/ability/' + id[1]).success(function (res) {
							var abilityDescription = res.effect_entries.filter(function (entry) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getMultipliers = __webpack_require__(53);
	...
	var pokemonMultipliers = function pokemonMultipliers($scope, $rootScope) {
	    ...
	    $scope.$on('init', function () {
	        if ($rootScope.currentPokemon && $rootScope.currentPokemon.types) {
	            ...
	            try {
	                for (var _iterator = Object.entries(multipliers.attack)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            try {
	                for (var _iterator2 = Object.entries(multipliers.defense)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _all_types = __webpack_require__(54);
		...
		$scope.$on('init', function () {
			...
			$scope.getHeldItem = function (url) {
				...
				if (id && id.length > 0) {
					...
					if (!localHeldItem) {
						$http.get(_config.config.baseUrl + '/item/' + id[1]).success(function (res) {
							var heldItemDescription = res.effect_entries.filter(function (entry) {
								if (entry.language.name === 'en') {
									return true;
								} else {
									return false;
	...
	function getInfoFactory($http, $q) {
	    return {
	        getPokemon: function getPokemon(currentPokemon) {
	            ...
	            $http.get(_config.config.baseUrl + '/pokemon/' + (_pokemons2.default.indexOf(currentPokemon) + 1)).success(function (res) {
	        ...
	        getSpecie: function getSpecie(currentPokemon) {
	            var deferred = $q.defer();
	            $http.get(_config.config.baseUrl + '/pokemon-species/' + (_pokemons2.default.indexOf(currentPokemon) + 1)).success(function (res) {
	                deferred.resolve(res);
	            }).error(function (data) {
	                console.log(data);
	                Bugsnag.notify("ErrorName", "Something broke!", {
